...
export const LampContainer = ({
  ...
  const mobileConicWidth = "14rem";
  const desktopConicWidth = "28rem";
  const mobileLightbarWidth = "15rem";
  const desktopLightbarWidth = "30rem";
  ...
  return (
    <div
      className={cn(
        ...
        "bg-background bg-[linear-gradient(to_right,hsl(var(--foreground))_0.5px,transparent_0.5px),linear-gradient(to_bottom,hsl(var(--foreground))_0.5px,transparent_0.5px)] bg-[size:28px_48px] opacity-20",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          whileInView={{ opacity: 1, width: isMobile ? mobileConicWidth : desktopConicWidth }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-cyan-400 opacity-50 blur-3xl dark:bg-purple-500"></div>
        <motion.div
        ...
        <motion.div
          ...
          whileInView={{ width: isMobile ? mobileLightbarWidth : desktopLightbarWidth }}
          transition={{
            delay: 0.3,
            duration: 0.8,
            ease: "easeInOut",
